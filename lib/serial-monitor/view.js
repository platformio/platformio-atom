...
export class SerialMonitorView {
  ...
  constructor() {
    ...
    this.rtsInput = this.element.querySelector('.rts-input');
    this.dtrInput = this.element.querySelector('.dtr-input');
  ...
  getRTS() {
    return this.rtsInput.value;
  }

  setRTS(value) {
    this.rtsInput.value = value;
  }

  getDTR() {
    return this.dtrInput.value;
  }

  setDTR(value) {
    this.dtrInput.value = value;
  }
