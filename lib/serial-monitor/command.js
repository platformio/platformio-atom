...
const RTS_KEY = 'platformio-ide:serial-monitor-rts';
const DTR_KEY = 'platformio-ide:serial-monitor-dtr';
...
export function command() {
  ...
  view.handleOpen = () => {
    ...
    localStorage.setItem(RTS_KEY, view.getRTS());
    localStorage.setItem(DTR_KEY, view.getDTR());
  ...
  const defaultRTS = parseInt(localStorage.getItem(RTS_KEY) || '1');
  view.setRTS(defaultRTS);
  const defaultDTR = parseInt(localStorage.getItem(DTR_KEY) || '1');
  view.setDTR(defaultDTR);
